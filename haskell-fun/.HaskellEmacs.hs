-- f3483994d1ffb72a8dc3e490109b1000
...
dispatcher = M.fromList $
  ...
  ] ++ [("Cabal.buildTargetNames",transform(Cabal.buildTargetNames)),("Matrix.identity",transform(Matrix.identity)),("Matrix.isIdentity",transform(Matrix.isIdentity)),("Matrix.dyadic",transform(\ (x1,x2) -> Matrix.dyadic x1 x2)),("Matrix.transpose",transform(Matrix.transpose))]
...
arityList :: [(Text, Int)]
arityList = [("Cabal.buildTargetNames",arity Cabal.buildTargetNames),("Matrix.identity",arity Matrix.identity),("Matrix.isIdentity",arity Matrix.isIdentity),("Matrix.dyadic",arity Matrix.dyadic),("Matrix.transpose",arity Matrix.transpose)]
